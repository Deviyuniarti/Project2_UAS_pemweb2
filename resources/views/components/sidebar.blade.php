<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar"
    style="background: linear-gradient(to bottom, #8E24AA, #42A5F5);">
    <!-- Sidebar - Brand -->
    ...
    <li class="nav-item">
        <a class="nav-link" href="/posisi_pekerjaan">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link" href="/inventaris_restoran">
            <i class="fas fa-fw fa-folder"></i>
            <span>Inventaris Restoran</span>
        </a>
